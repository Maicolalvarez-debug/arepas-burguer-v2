        ...
        <>
          ...
          <div className="w-full h-80 rounded-2xl border shadow p-2">
            <RC.ResponsiveContainer width="100%" height="100%">
              <RC.LineChart data={data?.series || []}>
                <RC.CartesianGrid strokeDasharray="3 3" />
                <RC.XAxis dataKey="label" />
                <RC.YAxis />
                <RC.Tooltip />
                <RC.Legend />
                <RC.Line type="monotone" dataKey="gross" />
                <RC.Line type="monotone" dataKey="net" />
                <RC.Line type="monotone" dataKey="cost" />
                <RC.Line type="monotone" dataKey="profit" />
              </RC.LineChart>
