...
async function main() {
  ...
  const modsRaw = [
    ...
    { name: "Queso amarillo", priceDelta: 2000, costDelta: 900, stock: 200, active: true },
    { name: "Tocineta extra", priceDelta: 2500, costDelta: 1200, stock: 200, active: true },
  ];
  const mods = [];
  ...
  // productos reales demo (editables luego)
  const arepas = [
