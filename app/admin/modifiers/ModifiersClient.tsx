...
export default function ModifiersClient({ data }: { data: Modifier[] }) {
  const [items, setItems] = useState<Modifier[]>(Array.isArray(data) ? data : []);
  ...
  return (
    <div className="p-4 space-y-3">
      ...
      {items.length === 0 && (
        <div className="text-sm opacity-70">No hay modificadores para mostrar.</div>
      )}
